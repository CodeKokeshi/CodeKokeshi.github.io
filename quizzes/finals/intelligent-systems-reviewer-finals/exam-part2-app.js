(() => {
  // Filter questions for Part 2 (Lessons 8-10)
  const part2Questions = examQuestions.filter(q => 
    q.lesson === "Lesson 8" || q.lesson === "Lesson 9" || q.lesson === "Lesson 10"
  );
  ...
  function initExam() {
    examState.shuffledQuestions = part2Questions.map(q => {
