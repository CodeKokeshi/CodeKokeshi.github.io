(() => {
  // Filter questions for Part 1 (Lessons 5-6)
  const part1Questions = examQuestions.filter(q => 
    q.lesson === "Lesson 5" || q.lesson === "Lesson 6"
  );
  ...
  function calculateAndShowResults() {
    ...
    document.getElementById('totalQuestionsResult').textContent = examState.shuffledQuestions.length;
