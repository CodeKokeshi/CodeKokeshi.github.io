...
// ===========================
function saveStats() {
    localStorage.setItem('iot_flashcardStats', JSON.stringify({
...
function loadStats() {
    const saved = localStorage.getItem('iot_flashcardStats');
    if (saved) {
...
function saveQuizHistory(score, correct, incorrect, timeTaken) {
    let history = JSON.parse(localStorage.getItem('iot_quizHistory') || '[]');
    history.push({
        score,
        correct,
        incorrect,
    ...
    localStorage.setItem('iot_quizHistory', JSON.stringify(history));
}

function getQuizHistory() {
    return JSON.parse(localStorage.getItem('iot_quizHistory') || '[]');
}
...
document.getElementById('reset-stats').addEventListener('click', () => {
    if (confirm('Are you sure you want to reset ALL statistics? This cannot be undone!')) {
        localStorage.removeItem('iot_flashcardStats');
        localStorage.removeItem('iot_quizHistory');
        flashcardStats.recalled.clear();
        flashcardStats.notRecalled.clear();
        updateStatsDisplay();
